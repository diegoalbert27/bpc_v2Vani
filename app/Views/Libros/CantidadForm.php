...
<div class="card shadow mt-4">
    ...
    <form action="<?php echo $helpers->generateUrl('libro', 'editcantidad', [ 'id' => $inventario->id_inv ]) ?>" method="POST">
            <div class="row p-2 mb-3">
                <div class="col-md-6">
                    <label class="form-label" for="cantidad_actual">Cantidad de Existencia:</label>
            ...
            <div class="row p-2 mb-3">
                <div class="col-md-6">
                    <label class="form-label" for="cantidad_total">Cantidad Total:</label>
                ...
                <div class="col-md-6">
                    <label class="form-label" for="cantidad_resto">Cantidad Resto:</label>
